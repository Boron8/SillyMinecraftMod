# TODO LIST FOR CREEPERTESTMOD


| Topic             | Added | Description                          |
|-------------------|:-----:|--------------------------------------|
| Tutorial Bug      |  YES  | Check if Sender is instanceof player |
| Hammer Textures   |  NO   | Textures for Stone/Iron Hammers      |
| Plate Textures    |  NO   | Textures for Plates                  |
